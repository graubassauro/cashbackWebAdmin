...
@Component({
  selector: 'app-grafics-data',
  templateUrl: './grafics-data.component.html',
  styleUrls: ['./grafics-data.component.css']
})
export class GraficsDataComponent implements OnInit {
